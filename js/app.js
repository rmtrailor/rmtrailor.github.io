...
var data = {
  homeHTML: {
    ...
    p:
      "<p>I'm a Software Engineer based in the San Francisco Bay Area interested in full-stack web development and data visualization.</p>",
    ulOpen: '<ul class="button-links">',
    li: {
      one:
        '<li><a href="mailto:contact@rubintrailor.com"><i class="fa fa-envelope"></i></a></li>',
      two:
        '<li><a href="https://github.com/rmtrailor"><i class="fa fa-github"></i></a></li>',
      three:
        '<li><a href="https://www.linkedin.com/in/rmtrailor"><i class="fa fa-linkedin-square"></i></a></li>',
    },
    ulClose: '</ul>',
  },
  aboutHTML: {
    h1: '<h1>Hello</h1>',
    bio: `<p>My name is Rubin Trailor and I'm currently a Full-Stack Software Engineer at Auction.com.
  ...
  educationHTML: {
    ...
    universityName:
      '<h2 class="university-name">University of San Francisco, San Francisco, CA</h2>',
    universityDescription: `<p class="university-description">
                                    B.Sc. Computer Science, Cum Laude Honors Graduate <br>
                                    Dean's List: 2013 &#8211; 2017<br>
                                    Major GPA: 3.91<br>
                                </p>`,
    ...
    listings: [
      {
        ...
        location: 'Auction.com',
        duration: 'Jun. 2017 - Current',
        description: `Built a business intelligence dashboard Portfolio Interact for real estate sellers using React, Redux, 
          Recharts.js, D3.js that featured property asset-level detail, portfolio reporting, and smart analytics. Used by 
          companies such as Bank of America, Chase, and Wells Fargo.`,
      },
      {
        title: 'Software Engineer Intern Co-op',
        location: 'Ten-X',
        duration: 'Jan. 2017 - May 2017',
        description: `Interned with a small team for the senior capstone project at USF in which the core focus was to build 
          an internal web application for interviewing candidates. Oversaw the backend of the application where I designed
          and implemented a RESTful API using Node.js with Express and a MySQL database. `,
      },
      {
        title: 'Software Engineer Intern',
        location: 'CA Technologies',
        duration: 'Dec. 2016 - May 2017',
        description: `Focused on the frontend side of a web application using React and Redux. Worked on communication implementations 
          with the backend of the application and UI design. Developed user action and data sharing techniques across 
          geographically-diverse clients. Implemented data visualization components into the application using D3.js.`,
      },
      {
        title: 'Teaching Assistant',
        location: 'University of San Francisco',
        duration: 'Aug. 2015 - Dec. 2016',
        description: `Grading, holding office hours to help students, and assistance during class periods. Tutored Java and Python`,
      },
      {
        title: 'Research Assistant',
        location: 'University of San Francisco',
        duration: 'Dec. 2015 - Feb. 2016',
        description: `I assisted on a research project that focused on focus and context visualizations. I helped develop a tablet app 
          that tested these types of visualizations using the Android SDK and then worked on a Desktop version using C++.`,
      },
    ],
  },
};
...
var replaceContent = function (subject) {
  ...
  switch (subject) {
    ...
    case 'education':
      ...
      var $leftContainer = $(educationHTML.leftContainer).addClass(
        'left-container'
      );
      var $universityName = $(educationHTML.universityName);
      var $universityDescription = $(educationHTML.universityDescription);
      var $rightContainer = $(educationHTML.rightContainer).addClass(
        'right-container'
      );
      var $universityImage = $(educationHTML.universityImage).attr(
        'id',
        'usf-picture'
      );
